                ...
                <tbody>
                    <tr v-if="booking.length" v-for="(item,index) in booking" :key="index">
                        ...
                        <td class="flex gap-2">
                            ...
                            <label for="edit" @click="get_booking(item)" class="btn btn-xs btn-primary">
                                <i class="fa fa-pen"></i>
                            </label>
                            <label @click="get_batal(item)" for="batal" class="btn btn-xs btn-error">
...
export default {
    ...
    methods: {
        submit() {
            this.form.post(route('menu.data.superadmin.booking.store'), {
                onSuccess: () => {
        ...
        submit_batal() {
            this.form.put(route('menu.data.superadmin.booking.update', {
